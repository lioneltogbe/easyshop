...
<head>
    ...
    <style>
        ...
        * {
        ...
        .navbar-group[open] > summary {
            background: linear-gradient(135deg, var(--primary) 0%, var(--primary-dark) 100%);
            color: var(--white);
            box-shadow: var(--shadow);
        }

        .navbar-group summary::-webkit-details-marker,
        .navbar-group summary::marker {
            display: none;
            content: none;
        }
        ...
        .navbar-submenu {
            display: grid;
            gap: 0.25rem;
            padding: 0.55rem 0.75rem 0.75rem 1.75rem;
        }

        .navbar-submenu .navbar-tab {
        ...
        .navbar-submenu .navbar-tab:hover {
            background: transparent;
            color: inherit;
        }

        .navbar-submenu .navbar-tab.active {
            background: transparent;
            color: var(--primary);
        }

        .navbar-group .chevron {
            transition: transform 0.2s ease;
        }

        .navbar-group[open] .chevron {
...
<div class="app-layout">
     ...
     <div class="main-content">
        ...
        <div class="topbar">
            ...
            <!-- <div class="topbar-left">
                <h2 class="topbar-title">easyShop</h2>
            </div> -->


            <div class="topbar-center">
                <input type="text" placeholder="Rechercher..." class="topbar-search">
            </div>
            ...
            <div class="topbar-right">
                ...
                <!-- Settings -->
                <button class="topbar-icon"  >
                    <a href="{{ route('parametres.index') }}" title="Paramètres" style="text-decoration: none;" >
                        ⚙️
                    </a>
                </button>
        ...
        @if(isset($tabs))
            <div class="tabs">
                @foreach($tabs as $tab)
                    <a href="{{ $tab['url'] }}" class="tab-link {{ $tab['active'] ? 'active' : '' }}">
                        {{ $tab['label'] }}
                    </a>
                @endforeach
            </div>
    ...
    menuToggle.addEventListener("click", () => {
        ...
        // Change l’icône entre "bars" et "times"
