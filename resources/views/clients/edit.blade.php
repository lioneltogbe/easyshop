...
@section('content')
<style>
/* Même style que create.blade.php */
:root {
...
<div class="container" style="padding-top: var(--spacing-2xl);">
    <div class="header-section">
        <a href="{{ route('clients.index') }}" class="breadcrumb">← Retour aux clients</a>
        <h1 class="page-title">Éditer le Client</h1>
    </div>
            ...
            <form action="{{ route('clients.update', $client->id) }}" method="POST">
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="creditLimit" id="creditLimit" class="form-control @error('creditLimit') is-invalid @enderror" 
                               value="{{ old('creditLimit', $client->creditLimit) }}" min="0" required>
                        @error('creditLimit')
                        <div class="form-error">{{ $message }}</div>
                        @enderror
                    </div>
