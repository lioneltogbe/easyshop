...
@section('title', 'Dépenses - easyShop')
...
<div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:1.5rem;">
    <h1 style="font-size:2rem;font-weight:700;color:#111827;">Dépenses</h1>
</div>

<x-pagination-controls
    :action="route('finances.depenses')"
    :params="$params"
...
<p style="margin-bottom:.75rem;color:#6B7280;font-size:.875rem;">
    Affichage {{ $transactions->firstItem() }}–{{ $transactions->lastItem() }} sur {{ $transactions->total() }} dépenses
</p>
@endif
